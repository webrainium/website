      ...
      <section className="pt-24 pb-16 bg-gradient-soft">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="font-body text-coral font-semibold">Our Stories</span>
          </div>
          <h1 className="font-heading font-bold text-4xl md:text-6xl text-primary mb-6">
            Stories & Culture
          </h1>
          <p className="font-body text-xl text-muted-foreground max-w-3xl mx-auto">
            Personal stories, company culture, lessons learned, and the human side of building technology.
          </p>
        </div>
      </section>
          ...
          <Card className="p-12 bg-gradient-soft border-0">
            <div className="space-y-6">
              ...
              <p className="font-body text-xl text-muted-foreground">
                We're preparing heartfelt stories about our journey, the people we've met, 
                lessons we've learned, and what it means to build technology with humanity at its core.
              </p>
